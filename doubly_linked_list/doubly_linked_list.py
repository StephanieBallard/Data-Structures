...
#  * The `DoublyLinkedList` class itself should have the methods: 
# `add_to_head`, `add_to_tail`, `remove_from_head`, `remove_from_tail`, `move_to_front`, `move_to_end`, `delete`, and `get_max`.
